package com.example.admin.programma1.models;
...
public class GameModel {
    ...
    /**
     * очищаем игровое поле присваиваю EMPUTY=0 элементам массива [][]
     * так же очещаем переменную winer(победитель)
     */
    ...
    /**
     * проверяем есть ли на поле выигрышная ситуация
     * возвращаем true или false
     * на вход подаем элемент NOUGHT=1 или CROSS = 2
     * в зависиммости от проверки
     */
    ...
    /**
     * Делаем ход на выигрыш или блокируем выигрышный ход противника
     * выгодные позиции напрямую прописаны в коде
     */
    ...
    /**
     * поставить отимальный код для выигрыша
     */
